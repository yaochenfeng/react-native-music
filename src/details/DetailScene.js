...
import { TextTool,Avatar,IconWidget } from '../components';
...
export default class DetailScene extends React.Component {
    ...
    static navigationOptions = ({navigation}) => ({
        ...
        }}><Icon name="ios-arrow-back" size={30} color="#ffffff" style={{marginLeft: 20}} /></TouchableOpacity>,
        headerRight: <View style={{flexDirection: 'row', justifyContent: 'flex-end', width: screen.width * 0.25, paddingRight: 10}}>
            <Icon name="ios-more" size={25} style={{marginRight: 20}} color={color.white} />
    ...
    renderHeader = () => {
        ...
        return (
            <View style={styles.header}>
                ...
                <View style={{height: 50, justifyContent: 'space-around', flexDirection: 'row', backgroundColor: 'transparent', paddingBottom: 10, alignItems: 'center'}}>
                    ...
                    <IconWidget icon="ios-download-outline" color={color.white} title='下载' />
